    ...
    return (
        <>  
            ...
            <div style={{width: '100%', textAlign: 'center', marginBottom: '20px', marginTop: '20px'}}>
                <Title editable={ access > 3 ? false : { onChange: (text: string) => handleUpdateName(text) }} style={{ marginBottom: '20px' }} level={widthScreen < 1370 ? 5 : widthScreen < 1605 ? 4 : 4} >{procObject.name}</Title>
               <Image
                    src={procObject.foto ? server + procObject.foto : empty}
