...
import { EquipGroupsType, VMPDepartmentsType, createNewEquipGroup, createNewVMPDepartment } from "../../../../redux/Reducers/appReducer"



export const NewEquipGroup: React.FC = () => {
